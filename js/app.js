(() => {
    ...
    (() => {
        ...
        if (document.querySelector("[data-datepicker]")) {
            datepicker_min("[data-datepicker]", {
        ...
        modules_flsModules.tippy = tippy_esm("[data-tippy-content-2]", {
        ...
        function e(t, e) {
            if (null == t) return {};
            var r, i, n = {}, s = Object.keys(t);
            for (i = 0; i < s.length; i++) e.indexOf(r = s[i]) >= 0 || (n[r] = t[r]);
            return n;
        }
        const r = new Set;
        function i(t, ...e) {
            r.has(t) || (r.add(t), "undefined" != typeof console && console.warn(t, ...e));
        }
        function n(t, e = "assertion failed") {
            if (null == t) throw Error(e);
        }
        let s;
        const a = {}, o = /^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/, l = /^rgba?\(\s*(\d+%?)\s*,\s*(\d+%?)\s*,\s*(\d+%?)(?:\s*[,/]\s*(\d*(?:\.\d*)?%?)?)?\)$/;
        function h(t) {
            if (o.test(t)) return function(t) {
                return t.length < 7 ? [ Number("0x" + t[1].repeat(2)), Number("0x" + t[2].repeat(2)), Number("0x" + t[3].repeat(2)), 4 === t.length ? 1 : Number("0x" + t[4].repeat(2)) ] : [ Number("0x" + t.slice(1, 3)), Number("0x" + t.slice(3, 5)), Number("0x" + t.slice(5, 7)), 7 === t.length ? 1 : Number("0x" + t.slice(7, 9)) ];
            }(t);
            if (l.test(t)) return c(t);
            if (a[t]) return a[t].slice(0);
            s || (s = document.createElement("div"), s.style.cssText = "\n        position: absolute;\n        visibility: hidden;\n        pointer-events: none;\n      "), 
            s.style.color = t, document.body.appendChild(s);
            const e = getComputedStyle(s).color;
            return s.remove(), a[t] = c(e);
        }
        function c(t) {
            try {
                const [, e, r, i, n = "1"] = t.match(l);
                return [ e, r, i, n ].map((t => t.endsWith("%") ? 2.55 * Number(t.slice(0, -1)) : Number(t)));
            } catch (e) {
        ...
        function p(t) {
            const [e, r, i] = t.map((t => t / 255));
            return .2126 * d(e) + .7152 * d(r) + .0722 * d(i);
        }
        const d = t => t <= .03928 ? t / 12.92 : Math.pow((t + .055) / 1.055, 2.4);
        function m(t, e = 1) {
            return g(t, -e);
        }
        function _(t, e = 1) {
        ...
        function g(t, e = 1) {
            const [r, i, n, s = 1] = t, a = function([t, e, r]) {
                const i = k((.4124564 * (t = b(t)) + .3575761 * (e = b(e)) + .1804375 * (r = b(r))) / f.Xn), n = k((.2126729 * t + .7151522 * e + .072175 * r) / f.Yn), s = 116 * n - 16;
                return [ s < 0 ? 0 : s, 500 * (i - n), 200 * (n - k((.0193339 * t + .119192 * e + .9503041 * r) / f.Zn)) ];
            }([ r, i, n ]);
            a[0] += f.Kn * e;
            const o = function([t, e, r]) {
                let i, n, s;
                return n = (t + 16) / 116, i = isNaN(e) ? n : n + e / 500, s = isNaN(r) ? n : n - r / 200, 
                n = f.Yn * w(n), i = f.Xn * w(i), s = f.Zn * w(s), [ y(3.2404542 * i - 1.5371385 * n - .4985314 * s), y(-.969266 * i + 1.8760108 * n + .041556 * s), y(.0556434 * i - .2040259 * n + 1.0572252 * s) ];
            }(a);
            return 1 === s ? o : [ ...o, s ];
        }
        const f = {
        ...
        function y(t) {
            return 255 * (t <= .00304 ? 12.92 * t : 1.055 * Math.pow(t, 1 / 2.4) - .055);
        }
        function w(t) {
        ...
        class L {
            static getInstance(t) {
                return this.instances_.has(t) || this.instances_.set(t, new L(t)), this.instances_.get(t);
            }
            constructor(t) {
                this.map_ = void 0, this.mapState_ = void 0, this.listeners_ = [], this.map_ = t, 
                t.addListener("bounds_changed", (() => this.handleBoundsChange())), this.handleBoundsChange();
            }
            addListener(t) {
                return this.listeners_.push(t), {
                    remove: () => {
            ...
            handleBoundsChange() {
                const t = this.map_.getCenter(), e = this.map_.getBounds();
                if (t && e) {
                    this.mapState_ = {
                        center: t,
                        bounds: e,
                    ...
                    for (const t of this.listeners_) t(this.mapState_);
                } else console.debug("MapStateObserver.handleBoundsChange(): map center and/or bounds undefined. Not updating map state.");
            }
        }
        L.instances_ = new Map;
        const V = [ {
            isValid: t => "object" == typeof t && t instanceof google.maps.LatLng,
            fromLatLng: t => t,
            toLatLng: t => t
        }, {
            isValid: t => Array.isArray(t) && 2 === t.length,
            fromLatLng: t => [ t.lng(), t.lat() ],
            toLatLng: t => new google.maps.LatLng(t[1], t[0])
        }, {
            isValid: t => null !== t && "object" == typeof t && "lat" in t && "lng" in t,
            fromLatLng: t => t.toJSON(),
            toLatLng: t => new google.maps.LatLng(t)
        } ];
        function A(t) {
            for (const e of V) if (e.isValid(t)) return e;
            throw new Error("unknown position format");
        }
        function E(t) {
            return A(t).toLatLng(t);
        }
        const O = [ "position", "draggable", "collisionBehavior", "title", "zIndex", "color", "backgroundColor", "borderColor", "glyphColor", "icon", "glyph", "scale", "content", "classList" ];
        var C;
        class S {
            constructor(t) {
            ...
            getComputedAttributeValue(t) {
                const e = this.marker_[t];
                if ("function" != typeof e) return this.marker_[t];
                if (this.callbackDepth_++, this.callbackDepth_ > 10) throw new Error("maximum recursion depth reached. This is probably caused by a cyclic dependency in dynamic attributes.");
                const {map: r, data: i, marker: n} = this.marker_.getDynamicAttributeState(), s = e({
                    data: i,
                    map: r,
                    marker: n,
                    attr: this
                });
                return this.callbackDepth_--, s;
            }
        }
        C = S, (() => {
            ...
            for (const t of O) "position" !== t && Object.defineProperty(C.prototype, t, {
                get() {
        ...
        var P, M, D;
        class N {
            static registerIconProvider(t, e = "default") {
                N.iconProviders.set(e, t);
            }
            constructor(t = {}, r) {
                this.map_ = null, this.mapObserver_ = null, this.mapEventListeners_ = [], this.data_ = null, 
                this.markerState_ = {
                    hovered: !1,
                    content: document.createElement("div")
                }, this.attributes_ = {}, this.attributeDefaults_ = {}, this.computedAttributes_ = new S(this), 
                this.markerView_ = void 0, this.pinView_ = void 0, this.updateScheduled_ = !1;
                const {map: i} = t, n = e(t, I);
                !function() {
                    if (!("google" in window) || !google.maps) throw console.error("Google Maps API couldn't be found. Please make sure to wait for the Google Maps API to load before creating markers."), 
                    new Error("Google Maps API not found.");
                    if (google.maps && !google.maps.marker) throw console.error("Google Maps API was loaded without the required marker-library. To load it, add the '&libraries=marker' parameter to the API url or use `await google.maps.importLibrary('marker');` before creating a marker."), 
                    new Error("Google Maps Marker Library not found.");
                }(), this.pinView_ = new google.maps.marker.PinElement, this.markerView_ = new google.maps.marker.AdvancedMarkerElement, 
                this.markerView_.content = this.pinView_.element, r && (this.data_ = r), this.setAttributes(n), 
                i && (this.map = i, this.update());
            }
            addListener(t, e) {
                if (t in D) return this.markerView_.addListener("click" === t ? "gmp-click" : t, e);
                const r = this.markerView_.element;
                return n(r), r.addEventListener(t, e), {
                    remove() {
            ...
            set map(t) {
                this.map_ !== t && (this.unbindEvents_(), this.mapObserver_ = null, this.map_ = t, 
                t && (this.mapObserver_ = L.getInstance(t), this.bindEvents_()), this.update());
            }
            setData(t) {
            ...
            update() {
                this.updateScheduled_ || (this.updateScheduled_ = !0, queueMicrotask((() => {
                    this.updateScheduled_ = !1, this.performUpdate();
                })));
            }
            performUpdate() {
                if (!this.map) return void (this.markerView_.map = null);
                const t = this.computedAttributes_, e = t.position;
                e ? (this.markerView_.map !== this.map_ && (this.markerView_.map = this.map_), this.markerView_.position = e, 
                this.markerView_.gmpDraggable = t.draggable || !1, this.markerView_.title = t.title || "", 
                this.markerView_.zIndex = t.zIndex, this.markerView_.collisionBehavior = t.collisionBehavior, 
                this.pinView_.scale = t.scale, this.updateContent_(t), t.content && (this.markerState_.content = t.content)) : this.markerView_.map = null;
            }
            updateContent_(t) {
                const {content: e, classList: r} = t;
                if (e ? (e.className = r ? Array.isArray(r) ? r.join(" ") : r : "", this.markerView_.content = e) : (this.markerView_.content = this.pinView_.element, 
                this.updateColors_(t), this.updateGlyph_(t)), this.markerView_.element) {
                    const e = this.markerView_.element, {color: r = null, backgroundColor: i = null, glyphColor: n = null, borderColor: s = null, scale: a = null} = t;
                    e.style.setProperty("--marker-color", r), e.style.setProperty("--marker-background-color", i), 
                    e.style.setProperty("--marker-glyph-color", n), e.style.setProperty("--marker-border-color", s), 
                    e.style.setProperty("--marker-scale", a ? a.toString() : null);
                }
            }
            updateColors_(t) {
                let {color: e, backgroundColor: r, borderColor: i, glyphColor: n} = t;
                if (e) {
                    const t = h(e), s = m(t, 1.2), a = _(t, 1.2);
                    r || (r = u(t)), i || (i = u(s)), n || (n = u(p(t) > .4 ? s : a));
                }
                this.pinView_.background = r, this.pinView_.borderColor = i, this.pinView_.glyphColor = n;
            }
            updateGlyph_(t) {
                if (!t.icon) return void (this.pinView_.glyph = t.glyph || void 0);
                let e = "default", r = t.icon;
                t.icon.includes(":") && ([e, r] = t.icon.split(":"));
                const n = N.iconProviders.get(e);
                n ? this.pinView_.glyph = n(r) : i(`An icon is set but no icon provider ${"default" === e ? "" : `with namespace '${e}' `}is configured.\nYou can register an icon-provider using e.g. \`Marker.iconProvider = MaterialIcons()\` to use the material icons webfont.`);
            }
            bindEvents_() {
                n(this.mapObserver_), this.mapEventListeners_ = [ this.mapObserver_.addListener((() => this.update())), this.addListener("pointerenter", (() => {
                    this.markerState_.hovered = !0, this.update();
                })), this.addListener("pointerleave", (() => {
                    this.markerState_.hovered = !1, this.update();
                })) ];
            }
            unbindEvents_() {
                for (const t of this.mapEventListeners_) t.remove();
                this.mapEventListeners_ = [];
            }
            getDynamicAttributeState() {
                return n(this.mapObserver_, "this.mapObserver_ is not defined"), {
                    data: this.data_,
        ...
        P = N, N.iconProviders = new Map, (() => {
            for (const t of O) Object.defineProperty(P.prototype, t, {
                get() {
                    return this.attributes_[t] || this.attributeDefaults_[t];
                },
                set(e) {
                    this.attributes_[t] = e, this.update();
                }
            });
        })(), function(t) {
            t.OPTIONAL_AND_HIDES_LOWER_PRIORITY = "OPTIONAL_AND_HIDES_LOWER_PRIORITY", t.REQUIRED = "REQUIRED", 
            t.REQUIRED_AND_HIDES_OPTIONAL = "REQUIRED_AND_HIDES_OPTIONAL";
        }(M || (M = {})), function(t) {
            t.click = "click", t.dragstart = "dragstart", t.drag = "drag", t.dragend = "dragend";
        }(D || (D = {}));
        const notfind_partnerImgInput = document.getElementById("notfind_myImg");
        if (notfind_partnerImgInput) notfind_partnerImgInput.onchange = function(event) {
            var target = event.target;
            var fileReader = new FileReader;
            fileReader.onload = function() {
                const notfind_partnerImg = document.getElementById("notfind_partnerImg");
                notfind_partnerImg.src = fileReader.result;
                notfind_partnerImg.style.width = "100%";
                notfind_partnerImg.style.height = "100%";
            };
            fileReader.readAsDataURL(target.files[0]);
        };
        const partner_partnerImgInput = document.getElementById("partner_myImg");
        if (partner_partnerImgInput) partner_partnerImgInput.onchange = function(event) {
            var target = event.target;
            var fileReader = new FileReader;
            fileReader.onload = function() {
                const partner_partnerImg = document.getElementById("partner_partnerImg");
                partner_partnerImg.src = fileReader.result;
                partner_partnerImg.style.width = "100%";
                partner_partnerImg.style.height = "100%";
            };
            fileReader.readAsDataURL(target.files[0]);
        };
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            searchForm.addEventListener("submit", (function(event) {
                ...
                var footerSection = document.querySelector(".flowers__footer");
                var showMoreButton = document.querySelector(".footer-section__more");
                var found = false;
                items.forEach((function(item) {
                    var title = item.querySelector(".item-flower__title").textContent.toLowerCase();
                    if (title.indexOf(searchText) === -1) item.style.display = "none"; else {
                        item.style.display = "block";
                        found = true;
                    }
                }));
                if (!found) {
                    searchResult.textContent = 'Sorry, no product with the name "' + searchText + '" was found.';
                    ...
                    if (!isSearchPerformed) {
                        ...
                        if (searchText === "") showMoreButton.style.display = "block"; else showMoreButton.style.display = "none";
                    }
                }
            }));
        }));
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            searchForm.addEventListener("submit", (function(event) {
                ...
                var searchResult = document.getElementById("searchResultComposition");
                var footerSection = document.querySelector(".composition__footer");
                var showMoreButton = document.querySelector(".footer-section__more-composition");
                var found = false;
                items.forEach((function(item) {
                    var title = item.querySelector(".item-composition__name").textContent.toLowerCase();
                    if (title.indexOf(searchText) === -1) item.style.display = "none"; else {
        ...
        function updatePopupNoneVisibility() {
            ...
            popupPayment.addEventListener("click", (function() {
        ...
        function addIncreaseButtonListener(button) {
            button.addEventListener("click", (function() {
                var item = button.closest(".item-cart");
                var quantityElement = item.querySelector("#itemCartQuantity");
                var quantityText = quantityElement.textContent.trim();
                var quantity = parseInt(quantityText.substring(0, quantityText.indexOf("x")));
                var priceElement = item.querySelector(".item-cart__subtitle");
                var priceText = priceElement.textContent.trim();
                var priceValue = parseFloat(priceText.replace("$", ""));
                quantity++;
                quantityElement.textContent = quantity + "x $" + priceValue.toFixed(2) + ` = $${(priceValue * quantity).toFixed(2)}`;
                updateTotalSum();
            }));
        }
        function addDecreaseButtonListener(button) {
            button.addEventListener("click", (function() {
                var item = button.closest(".item-cart");
                var quantityElement = item.querySelector("#itemCartQuantity");
                var quantityText = quantityElement.textContent.trim();
        ...
        function addQuantityButtonListeners() {
            var increaseButtons = document.querySelectorAll(".quantity-control#increaseQuantity");
            increaseButtons.forEach((function(button) {
                if (!button.hasListener) {
                    addIncreaseButtonListener(button);
                    button.hasListener = true;
                }
            }));
            var decreaseButtons = document.querySelectorAll(".quantity-control#decreaseQuantity");
            decreaseButtons.forEach((function(button) {
                if (!button.hasListener) {
                    addDecreaseButtonListener(button);
                    button.hasListener = true;
                }
            }));
        }
        ...
        function addFlowerToCart(item) {
            ...
            var flowerPrice = parseFloat(item.querySelector(".item-flower__coin").textContent.replace("$", ""));
            var flowerImg = item.querySelector(".item-flower__img img").getAttribute("src");
            var cartItems = document.querySelectorAll(".popup__item");
            var existingCartItem = null;
            cartItems.forEach((function(cartItem) {
                var cartItemTitle = cartItem.querySelector(".item-cart__title").textContent;
                if (cartItemTitle === flowerName) existingCartItem = cartItem;
            }));
            if (!existingCartItem) {
                var cartItem = document.createElement("div");
                cartItem.classList.add("popup__item");
                cartItem.classList.add("item-cart");
                cartItem.classList.add("item-cart_flower");
                cartItem.innerHTML = `\n              <div class="item-cart__content"> \n                  <div class="item-cart__img">\n                      <img src="${flowerImg}" alt="01">\n                  </div>\n                  <div class="item-cart__header">\n                      <h3 class="item-cart__title">${flowerName}</h3>\n                      <p class="item-cart__subtitle">$${flowerPrice.toFixed(2)}</p>\n                      <span id="itemCartQuantity">1x $${flowerPrice.toFixed(2)} = $${flowerPrice.toFixed(2)}</span>\n                      <div class="item-cart__quantity-controls">\n                          <button class="quantity-control" id="decreaseQuantity">-</button>\n                          <button class="quantity-control" id="increaseQuantity">+</button>\n                      </div>\n                  </div>\n              </div>\n              <button class="item-cart__delete">X</button>\n          `;
                var cartItemsContainer = document.querySelector(".popup__info");
                cartItemsContainer.appendChild(cartItem);
                updateTotalSum();
                updatePopupNoneVisibility();
                addQuantityButtonListeners();
            } else {
                var quantityElement = existingCartItem.querySelector("#itemCartQuantity");
                var quantityText = quantityElement.textContent.trim();
                var quantity = parseInt(quantityText.substring(0, quantityText.indexOf("x"))) + 1;
                quantityElement.textContent = quantity + "x $" + flowerPrice.toFixed(2) + " = $" + (quantity * flowerPrice).toFixed(2);
                updateTotalSum();
            }
        }
        var addButtons = document.querySelectorAll("#addFlowerToCart");
        addButtons.forEach((function(button) {
            button.addEventListener("click", (function(event) {
                var flowerItem = button.closest(".item-flower");
                addFlowerToCart(flowerItem);
                button.classList.add("animate-cart");
                setTimeout((() => {
        ...
        function hasFlowersInCart() {
            var flowerItems = document.querySelectorAll(".item-cart_flower");
            return flowerItems.length > 0;
        }
        document.querySelectorAll(".item-composition__cart").forEach((button => {
            button.addEventListener("click", (function() {
                if (hasFlowersInCart()) {
                    const existingTippy = button._tippy;
                    if (existingTippy) existingTippy.destroy();
                    button.removeAttribute("data-tippy-content");
                }
                if (!hasFlowersInCart()) return;
                const item = button.closest(".composition__item");
                const isAdded = item.classList.contains("added");
                if (!isAdded) {
                    var addedItem = document.querySelector(".composition__item.added");
                    if (addedItem) {
                        addedItem.classList.remove("added");
                        var cartItem = document.querySelector(".popup__item.item-cart_compostition");
                        if (cartItem) {
                            cartItem.remove();
                            updateTotalSum();
                            updatePopupNoneVisibility();
                    ...
                    addCompositionToCart(item);
                } else {
                    item.classList.remove("added");
                    cartItem = document.querySelector(".popup__item.item-cart_compostition");
                    if (cartItem) {
                        cartItem.remove();
                        updateTotalSum();
                        updatePopupNoneVisibility();
        ...
        function addCompositionToCart(item) {
            var compositionName = item.querySelector(".item-composition__name").textContent;
            var compositionPerformer = item.querySelector(".item-composition__performer").textContent;
            var compositionImage = item.querySelector(".item-composition__image img").getAttribute("src");
            var cartItem = document.createElement("div");
            cartItem.classList.add("popup__item");
            cartItem.classList.add("item-cart");
            cartItem.classList.add("item-cart_compostition");
            cartItem.innerHTML = `\n      <div class="item-cart__content"> \n         <div class="item-cart__img">\n            <img src="${compositionImage}" alt="${compositionName}">\n         </div>\n         <div class="item-cart__header">\n            <h4 class="item-cart__title">${compositionPerformer}</h4>\n            <h4 class="item-cart__subtitle">${compositionName}</h4>\n         </div>\n      </div>\n      <button class="item-cart__delete">X</button>\n   `;
            var cartItemsContainer = document.querySelector(".popup__info");
            cartItemsContainer.appendChild(cartItem);
            updateTotalSum();
            updatePopupNoneVisibility();
        ...
        popup.addEventListener("click", (function(event) {
            if (event.target.classList.contains("item-cart__delete")) {
                ...
                if (item) {
                    ...
                    updateTotalSum();
                    updatePopupNoneVisibility();
                    var compositionItem = document.querySelector(".composition__item.added");
                    if (compositionItem) compositionItem.classList.remove("added");
                    if (!hasFlowersInCart()) {
                        var compositionCartItem = document.querySelector(".popup__item.item-cart_compostition");
                        if (compositionCartItem) {
                            compositionCartItem.remove();
                            updatePopupNoneVisibility();
                            removeCartItem(item);
                        }
                    }
        ...
        videoServiceBtn.addEventListener("click", (function() {
            if (hasFlowersInCart()) {
                ...
                if (existingTippy) existingTippy.destroy();
                videoServiceBtn.removeAttribute("data-tippy-content");
            }
            if (!hasFlowersInCart()) return;
            const videoService = document.querySelector(".item-services-video");
            const videoServiceAdded = videoService.classList.contains("added");
            const mediaService = document.querySelector(".item-services__media");
            mediaService.classList.contains("added");
            if (!videoServiceAdded) {
                mediaService.style.display = "flex";
                if (videoServiceAdded) {
                    videoService.classList.remove("added");
                    var cartItem = document.querySelector(".popup__item.item-cart_service-video");
                    var cartMediaItem = document.querySelector(".popup__item.item-cart_service-media");
                    if (cartItem) {
                        cartMediaItem.remove();
                        cartItem.remove();
                        updateTotalSum();
                        updatePopupNoneVisibility();
                    }
                }
                videoService.classList.add("added");
                addServiceToCart(videoService);
            } else {
                mediaService.style.display = "none";
                mediaService.classList.remove("added");
                var serviceCartItems = document.querySelectorAll(".popup__item.item-cart_service");
                serviceCartItems.forEach((function(item) {
                    item.remove();
                    removeCartItem(item);
                }));
                updatePopupNoneVisibility();
                videoService.classList.remove("added");
                cartItem = document.querySelector(".popup__item.item-cart_service-video");
                cartMediaItem = document.querySelector(".popup__item.item-cart_service-media");
                if (cartItem) {
                    cartItem.remove();
                    updateTotalSum();
                    updatePopupNoneVisibility();
        ...
        mediaServiceBtn.addEventListener("click", (function() {
            if (hasFlowersInCart()) {
                ...
                if (existingTippy) existingTippy.destroy();
                mediaServiceBtn.removeAttribute("data-tippy-content");
            }
            if (!hasFlowersInCart()) return;
            const videoService = document.querySelector(".item-services-video");
            videoService.classList.contains("added");
            const mediaService = document.querySelector(".item-services__media");
            const mediaServiceAdded = mediaService.classList.contains("added");
            if (!mediaServiceAdded) {
                if (mediaServiceAdded) {
                    mediaService.classList.remove("added");
                    var cartItem = document.querySelector(".popup__item.item-cart_service-media");
                    if (cartItem) {
                        cartItem.remove();
                        updateTotalSum();
                        updatePopupNoneVisibility();
                ...
                mediaService.classList.add("added");
                addServiceToCart(mediaService);
            } else {
                mediaService.classList.remove("added");
                cartItem = document.querySelector(".popup__item.item-cart_service-media");
                if (cartItem) {
                    cartItem.remove();
                    updateTotalSum();
                    updatePopupNoneVisibility();
        ...
        function addServiceToCart(item) {
            const serviceName = item.querySelector(".item-services__name").innerText;
            const servicePriceText = item.querySelector(".item-services__price").innerText;
            const servicePrice = parseFloat(servicePriceText.replace("$", "").replace(",", ""));
            const serviceImage = item.querySelector(".item-services__image img").src;
            const serviceType = item.dataset.serviceType;
            const cartItem = document.createElement("div");
            cartItem.classList.add("popup__item", "item-cart", "item-cart_service", `item-cart_service-${serviceType}`);
            cartItem.setAttribute("data-service-type", serviceType);
            cartItem.innerHTML = `\n       <div class="item-cart__content">\n           <div class="item-cart__img">\n               <img src="${serviceImage}" alt="${serviceName}">\n           </div>\n           <div class="item-cart__header">\n               <h4 class="item-cart__title">${serviceName}</h4>\n               <p class="item-cart__subtitle">$${servicePrice.toFixed(2)}</p>\n           </div>\n       </div>\n       <button class="item-cart__delete">X</button>\n   `;
            const cartItemsContainer = document.querySelector(".popup__info");
            cartItemsContainer.appendChild(cartItem);
            updateTotalSum();
            updatePopupNoneVisibility();
        }
        popup.addEventListener("click", (function(event) {
            if (event.target.classList.contains("item-cart__delete")) {
                var item = event.target.closest(".popup__item");
                if (item) {
                    var serviceType = item.dataset.serviceType;
                    item.remove();
                    updateTotalSum();
                    updatePopupNoneVisibility();
                    var serviceItem = document.querySelector(`.services__item.added[data-service-type="${serviceType}"]`);
                    if (serviceItem) serviceItem.classList.remove("added");
                    const videoService = document.querySelector(".item-services-video");
                    const videoServiceAdded = videoService.classList.contains("added");
                    const mediaService = document.querySelector(".item-services__media");
                    mediaService.classList.contains("added");
                    if (!videoServiceAdded) mediaService.style.display = "none";
                    if (serviceType === "video") {
                        var mediaCartItem = document.querySelector(".popup__item.item-cart_service-media");
                        if (mediaCartItem) {
                            mediaCartItem.remove();
                            updatePopupNoneVisibility();
                        }
                    }
                    if (!hasFlowersInCart()) {
                        var servicesItems = document.querySelectorAll(".services__item");
                        servicesItems.forEach((function(items) {
                            items.classList.remove("added");
                        }));
                        var serviceCartItems = document.querySelectorAll(".popup__item.item-cart_service");
                        serviceCartItems.forEach((function(item) {
                            item.remove();
        ...
        async function initMap() {
            ...
            const centerNYC = new google.maps.LatLng(40.7128, -74.006);
            const radiusNYC = 5e4;
